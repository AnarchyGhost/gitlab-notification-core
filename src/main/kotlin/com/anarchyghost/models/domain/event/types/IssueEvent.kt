...
data class IssueEvent(
    ...
    @SerialName(value = "object_attributes") val objectAttributes: IssueObjectAttributes? = null,
    @SerialName(value = "repository") val repository: Repository? = null,
    @SerialName(value = "assignees") val assignees: List<User>? = null,
    @SerialName(value = "assignee") val assignee: User? = null,
    @SerialName(value = "labels") val labels: List<Label>? = null,
    @SerialName(value = "changes") val changes: IssueChanges? = null,
) : BaseEvent